...
func TestGenerateLocalMSP(t *testing.T) {
	...
	err := msp.GenerateLocalMSP(testDir, testName, &ca.CA{}, nil)
	...
	err = msp.GenerateLocalMSP(mspDir, testName, rootCA, nil)
	...
	err = msp.GenerateLocalMSP(testDir, testName, rootCA, nil)
