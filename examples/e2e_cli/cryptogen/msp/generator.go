...
func GenerateLocalMSP(baseDir, name string, rootCA *ca.CA, hsmOpts *csp.PKCS11Opts) error {
	...
	if err == nil {
		...
		priv, _, err := csp.GeneratePrivateKey(filepath.Join(baseDir, "keystore"), hsmOpts)
		response = err
		if err == nil {
